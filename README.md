...
```json
	[{"category" => "reference"}] #	Array(JSON::Any)
```
...
Everyone interacting in the JsonPath project’s codebases, issue trackers, chat rooms and mailing lists is expected to follow the [code of conduct](https://github.com/lribeiro/json_path.cr/blob/master/CODE_OF_CONDUCT.md).
